...
#define TEMP_SENSOR1_PIN    22  // thermistor data pin
#define PELTIER1_PWM_PIN    16  // enable1
#define PELTIER1_DIR_PIN1   17  // in1
#define PELTIER1_DIR_PIN2   18  // in2

// Temperature Control 2 configuration
#define TEMP_SENSOR2_PIN    21
