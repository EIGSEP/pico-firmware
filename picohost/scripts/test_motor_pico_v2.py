...
def main():
    ...
    parser.add_argument('--delay-az', type=int, default=600, help='Azimuth step delay (microseconds)')
    parser.add_argument('--delay-el', type=int, default=600, help='Elevation step delay (microseconds)')
